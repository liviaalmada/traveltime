...
import br.ufc.arida.analysis.model.measures.JeffreysDistance;
import br.ufc.arida.dao.ProbabilisticCostsDAO;

public class DBScanJeffreys {
...
//							String file = "clusters-turnos-jeffreys/clusters" + String.format("%.1f", EpsSim) + "-" + EpsNet
//									+ "-" + minPts + " - " + interval;
//							System.out.println("Processing " + file);
//							LinkScan alg = new LinkScan(graph, new JeffreysDistance());
...
//			}
			...
			String file = "clusterJeffrey" + String.format("%.1f", 15.) + "-" + 10
					+ "-" + 20 + " - " + 2;
			System.out.println("Processing " + file);
			LinkScan alg = new LinkScan(graph, new JeffreysDistance());
			alg.runAndSave(file, 15, 10, 20, 2);
		} catch (Exception e) {
